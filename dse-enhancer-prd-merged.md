...
**MVP+2将接入AI口语评分**（Whisper ASR + GPT-4o）：
- ASR转文字并分析发音准确性
- AI从发音、流利度、内容三维度评分
- 逐词发音纠错和示范
...
✗ **后续做（MVP上线后迭代）**：
- [ ] **MVP+1**：完整真题模考、**AI作文评分（ArkCode/GPT）**、**AI口语评分（Whisper+GPT）**、生词本/错题本导出PDF打印
- [ ] **MVP+2**：词汇PK对战 + 排行榜、家长端每周学习报告邮件
- [ ] **MVP+3**：亲子账号体系（支持多孩家庭）、讨论社区/学习打卡、人工作文/口语批改付费服务
