    ...
    <Card className="bg-white/10 backdrop-blur-lg border-white/20">
      ...
      <CardContent className="space-y-6">
        <div className="p-6 rounded-xl bg-white/5 border border-white/10">
          <p className="text-white text-lg leading-relaxed whitespace-pre-wrap">{question.content}</p>
        </div>
            ...
            <button
              ...
              className={`w-full p-4 text-left rounded-xl border-2 transition-all ${
                showResult
                  ...
                  : selectedOption === key
                  ? 'bg-purple-500/20 border-purple-500 text-white hover:bg-purple-500/30'
        ...
        <div className="flex gap-3 pt-4">
          {!showResult ? (
            <Button
              ...
              className="flex-1 h-12 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              提交答案
            </Button>
          ) : (
