...
interface ErrorReviewModuleProps {
  question: Question;
...
export default function ErrorReviewModule({
  question,
  questionIndex,
  totalQuestions,
  onAnswer,
  ...
  return (
    <Card className="bg-white/10 backdrop-blur-lg border-white/20">
      <CardHeader>
        ...
        <div className="flex items-center gap-2 bg-orange-500/20 rounded-lg px-3 py-1.5 inline-block">
          <RotateCcw className="w-4 h-4 text-orange-400" />
          <span className="text-orange-400 text-sm font-medium">这道题曾经答错过</span>
        </div>
      </CardHeader>
        ...
        <div className="flex gap-3 pt-4">
          {!showResult ? (
            <Button
              ...
              className="flex-1 h-12 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              提交答案
            </Button>
          ) : (
