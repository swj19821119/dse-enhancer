...
| 星期 | 模块1 | 模块2 | 模块3 | 模块4 | Part B 补充安排 |
|------|-------|-------|-------|-------|----------------|
| **周一** | 词汇 Part A | 语法 Part A | 阅读 Part A | 错题复习 |  |
| **周二** | 词汇 Part A | 语法 Part A | 听力 Part A | 错题复习 |  |
| **周三** | 词汇 Part A | 语法 Part A | 写作 Part A | 错题复习 | 听力 Part B（额外） |
| **周四** | 词汇 Part A | 语法 Part A | 口语 Part A | 错题复习 |  |
| **周五** | 词汇 Part A | 语法 Part A | 阅读 Part A | 错题复习 | 写作 Part B（额外） |
| **周六** | 词汇 Part A | 语法 Part A | 听力 Part A | 错题复习 |  |
| **周日** | 自由安排 | 自由安排 | 自由安排 | 自由安排 | 无强制一键学习，周日休息 |

---

### Part B 专项深度练
- 除了每日轮换里的 Part B，用户还可以去「专项练习」里完整练 Part A + Part B
- 周日可以自由安排，或者做一套完整模考
- 词汇 Part B 和语法 Part B 也在「专项练习」里提供
