...
> 范文由AI生成，按DSE Paper 2 Writing Part A情景写作标准分为Level 3/4/5三个等级
> 生成日期：2026-03-25
> 每道题目包含3个等级范文，共60篇（20题 × 3等级）

---

## 题目1：书信类（正式投诉信）

**题目要求**：你住在香港某公寓，最近楼上邻居经常深夜发出噪音，影响你休息。请给物业管理处写一封信投诉，要求他们采取行动。（约200字）
...
**特点**：
- ✅ 结构完整，语气正式得体
- ✅ 具体描述了噪音类型（music, furniture, footsteps）
- ✅ 说明了具体影响（sleep deprivation, academic performance）
- ✅ 尝试了沟通但未解决，增强说服力
- ✅ 词汇较丰富（excessive, deprivation, intervene）
- ✅ 句式有一定变化
...
**特点**：
- ✅ 语言高度正式，语气强烈但不失礼貌
- ✅ 词汇非常丰富且精准（profound dissatisfaction, emanating, intolerable, chronic, compromised, blatant violation, flagrant disregard）
- ✅ 句式复杂多样（分词结构、从句、倒装）
- ✅ 逻辑严密（问题描述→影响→已尝试解决→要求行动）
- ✅ 使用了高级连接词（consequently, notwithstanding, anticipate）

---

## 题目2：演讲辞（校园活动）

**题目要求**：你是学生会主席，请为下周的英语周活动写一篇演讲辞，鼓励同学们积极参与。（约250字）
...
```
Good morning, distinguished teachers and dear fellow students!
...
**题目要求**：你是班长，上周班级组织了一次敬老院探访活动。请写一份报告给班主任，汇报活动情况和同学们的反馈。（约200字）

### Level 3 范文

```
To: Miss Wong, Class Teacher
...
**题目要求**：你校英文报正在征稿，主题是"青少年沉迷手机"。请投稿一篇短文，分析原因并提出建议。（约250字）

### Level 3 范文

```
Title: Stop Phone Addiction
...
```
Title: Addressing the Pervasive Issue of Teenage Mobile Phone Addiction
...
```
Title: The Digital Epidemic: Confronting Adolescent Mobile Phone Addiction in the Modern Era
...
**题目要求**：你认为学校应该增加学生的体育锻炼时间。请给校长写一封信，说明理由并提出具体建议。（约200字）
...
| 特征 | Level 3 | Level 4 | Level 5 |
|------|---------|---------|---------|
| **词汇量** | 基础（小学-初中） | 良好（初中-高中） | 优秀（高中-大学） |
| **句式** | 简单句为主 | 长短句结合 | 复杂长句为主 |
| **连接词** | 基础（first, second, so） | 多样（however, consequently） | 高级（furthermore, notwithstanding） |
| **正式度** | 口语化 | 半正式 | 高度正式 |
| **逻辑** | 基本完整 | 清晰有层次 | 严密有深度 |

### 教学建议

1. **Level 3范文**：适合基础薄弱学生，重点学习基本结构和常用表达
2. **Level 4范文**：适合中等水平学生，学习丰富词汇和句式变化
3. **Level 5范文**：适合冲刺高分学生，学习高级词汇和复杂结构
...
*注：本文档包含5道题目范文（15篇），完整范文库应包含20题 × 3等级 = 60篇*
